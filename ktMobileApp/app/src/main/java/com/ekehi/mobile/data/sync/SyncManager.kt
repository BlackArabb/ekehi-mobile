package com.ekehi.mobile.data.sync
...
fun com.ekehi.mobile.data.local.entities.UserProfileEntity.toUserProfile() = com.ekehi.mobile.data.model.UserProfile(
    id = this.id,
    userId = this.userId,
...
fun com.ekehi.mobile.data.model.UserProfile.toEntity() = com.ekehi.mobile.data.local.entities.UserProfileEntity(
    id = this.id,
    userId = this.userId,
    username = this.username,
    totalCoins = this.totalCoins,
...
fun com.ekehi.mobile.data.model.SocialTask.toEntity(userId: String) = com.ekehi.mobile.data.local.entities.SocialTaskEntity(
    id = this.id,
    userId = userId,
    title = this.title,
